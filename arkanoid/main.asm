...
DEF NUMBER_OFFSET EQU $1A ; Dir del primer número (0) dentro del tileset, el resto van consecutivos
DEF SCORE_DEC   EQU $9870 ; Decenas
DEF SCORE_UNIT   EQU $9871 ;
...
Tiles:
	dw `33333333 ; BackTick ('): Numeric format GameboyGraphics 
	dw `33333333
	dw `33333333
	dw `33322222
	dw `33322222
...
IncreaseScorePackedBCD:
    ...
    adc [hl]            ; add 1
    daa                 ; convierte de hexadecimal a BCD -> 
    ld [hl], a          ; store score
...
UpdateScoreBoard:
    ld a, [wScore]     
    and %11110000       ; Obtener nibble superior mediante enmascaramiento
    swap a              ; Mover el nibble a la parte inferior para obtener el número
    add a, NUMBER_OFFSET ; Obtener el tile con offset + númro
    ld [SCORE_DEC], a  ; Mostrar el nuevo score

    ; Lo mismo con el nibble inferior, sin swap
    ld a, [wScore]      
    and %00001111       
    add a, NUMBER_OFFSET 
    ld [SCORE_UNIT], a  
...
; Gestión de la memoria más sencilla al usar las sections del ensamblador
